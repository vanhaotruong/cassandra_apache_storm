...
class Wind_Spout(Spout):
    ...
    def initialize(self, stormconf, context):
        ...
        csv_file_path = '/home/hp/Study/01_Ky_thuat_du_lieu/cassandra_apache_storm/raw_data/raw_wind_sensor.csv'
...
class Weather_Spout(Spout):
    ...
    def initialize(self, stormconf, context):
        # Open the CSV file
        csv_file_path ='/home/hp/Study/01_Ky_thuat_du_lieu/cassandra_apache_storm/raw_data/raw_weather_sensor.csv'
        self.file = open(csv_file_path, 'r')
        self.reader = csv.reader(self.file)
        next(self.reader, None)  # Skip the header
